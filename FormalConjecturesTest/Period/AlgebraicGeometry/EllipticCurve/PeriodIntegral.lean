...
public import FormalConjecturesTest.Period.AlgebraicGeometry.EllipticCurve.DivisionPolynomial.Real
...
`FormalConjecturesTest.Period.AlgebraicGeometry.EllipticCurve.DivisionPolynomial.Real`: when
