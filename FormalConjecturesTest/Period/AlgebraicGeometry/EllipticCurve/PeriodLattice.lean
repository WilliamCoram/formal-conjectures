...
public import FormalConjecturesTest.Period.Analysis.SpecialFunctions.Elliptic.Weierstrass.Conjugation
...
`FormalConjecturesTest.Period.AlgebraicGeometry.EllipticCurve.PeriodIntegral` as
...
`FormalConjecturesTest.Period.AlgebraicGeometry.EllipticCurve.RealPeriod`. The lattice side
...
* `PeriodPair.exists_g₂_g₃`: a lattice with any prescribed nondegenerate invariants exists.
  Proved in `FormalConjecturesTest.Period.Analysis.SpecialFunctions.Elliptic.Weierstrass.Existence`,
...
* `PeriodPair.isReal_iff_exists_real`: a lattice is real if and only if its invariants are.
  Proved in
  `FormalConjecturesTest.Period.Analysis.SpecialFunctions.Elliptic.Weierstrass.Conjugation`, from
